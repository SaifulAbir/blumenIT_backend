...
from vendor.api.views import VendorAddNewCategoryAPIView, VendorAddNewSubCategoryAPIView, VendorBrandListAPIView, VendorDeleteCategoryAPIView, VendorDeleteSubCategoryAPIView, VendorProductDeleteAPI, VendorProductUpdateAPIView, VendorProductViewAPI, VendorSubCategoryListAPIView, VendorSubSubCategoryListAPIView, VendorTagListAPIView, VendorUnitListAPIView, VendorProductListAPI, VendorProductCreateAPIView, VendorDiscountListAPIView, SellerCreateAPIView,SellerListAPIView,SellerUpdateAPIView, SellerDeleteAPIView, VendorUpdateCategoryAPIView, VendorUpdateSubCategoryAPIView, VendorVatTypeListAPIView, VendorVideoProviderListAPIView
