...
from vendor.api.views import VendorBrandListAPIView, VendorCategoryListAPIView, VendorRequestAPIView, VendorRequestListAPI, VendorCreateAPIView, \
    OrganizationNamesListAPIView, VendorDetailAPIView, StoreSettingsUpdateAPIView, VendorSubCategoryListAPIView, VendorSubSubCategoryListAPIView, VendorUnitListAPIView
...
urlpatterns = [
    ...
    path('vendor-sub-category-list/<int:cid>/',
         VendorSubCategoryListAPIView.as_view()),
    path('vendor-sub-sub-category-list/<int:cid>/',
         VendorSubSubCategoryListAPIView.as_view()),
    path('vendor-brand-list/',
         VendorBrandListAPIView.as_view()),
    path('vendor-unit-list/',
         VendorUnitListAPIView.as_view()),
]
