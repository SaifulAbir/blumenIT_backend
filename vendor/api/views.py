...
from product.models import Brand, Category, DiscountTypes, Product, ProductAttributes, ProductMedia, ProductReview, \
    ProductTags, SubCategory, SubSubCategory, Tags, Units, VariantType
from user.models import CustomerProfile, User
from vendor.models import VendorRequest, Vendor, Seller
from vendor.serializers import VendorBrandSerializer, VendorCategorySerializer, VendorProductCreateSerializer, \
    VendorProductDetailsSerializer, VendorProductListSerializer, VendorProductUpdateSerializer, VendorRequestSerializer, \
    VendorCreateSerializer, OrganizationNameSerializer, \
