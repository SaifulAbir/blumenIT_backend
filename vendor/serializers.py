...
class AdminPosOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'order_id', 'product_count', 'vat_amount', 'discount_amount',
                  ...
                  'customer', 'in_house_order', 'total_price', 'sub_total']
...
class AboutUsSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'our_values', 'our_vision', 'our_mission',
                  'our_goals', 'customer_relationship', 'our_target_market', 'retail_wholesale_trade', 'promise_text', 'footer_text', 'our_values_image', 'customer_relationship_image', 'our_target_market_image', 'retail_wholesale_trade_image', 'is_active']
